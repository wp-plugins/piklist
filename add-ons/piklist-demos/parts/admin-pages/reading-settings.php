...
<div class="piklist-demo-highlight">
  ...
  <p>
    <strong><?php _e('IMPORTANT'); ?></strong> <?php _e('Changes you make on this page, will effect your site as if you are making changes to original Reading Settings.', 'piklist-demo'); ?>
  </p>
