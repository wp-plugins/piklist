...
?>
        <div class="updated-nag notice notice-warning">
          ...
          <p>
            <?php _e('The data structure for Piklist Add-More and Relationship fields have changed and require an update.'); ?>
          </p>
          <p>
            <?php _e('Do not save any Piklist data until you run this update.'); ?>
          </p>
          <p>
